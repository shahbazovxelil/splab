...
var fdSlider = (function() {
        var sliders           = {},
            ...
            fullARIA          = true,
            describedBy       = "fd-sliders-describedby",
            varSetRules       = {
                onfocus:true,
                onvalue:true
            },
        ...
        // Sets the valueSet variable for a specific sliders
        var setValueSet = function(sliderId, tf) {
                if(!(sliderId in sliders)) return;
                sliders[sliderId].setValueSet(!!tf);
        };

        // Javascript instantiation of a sliders (input type="text" or select list)
                        ...
                        if(inp.tagName.toLowerCase() == "input"
                           ...
                           (getAttribute(inp, "min") && getAttribute(inp, "min").search(fpRegExp) != -1
                            ...
                            getAttribute(inp, "step") && getAttribute(inp, "step").search(/^(any|([0-9]+(\.[0-9]+){0,1}))$/i) != -1
                                ...
                                if(inp.id && document.getElementById("fd-sliders-"+inp.id)) {
                                        continue;
                                // Destroy elements that have already been created but not resident in the DOM
                                } else if(inp.id && !document.getElementById("fd-sliders-"+inp.id)) {
                                        destroySingleSlider(inp.id);
                                };

                                // Create an id for the form element if necessary
                                if(!inp.id) { inp.id = "fd-sliders-form-elem-" + uniqueid++; };
                                ...
                                options = {
                                        ...
                                        vertical:       getAttribute(inp, "data-fd-sliders-vertical") ? true : !!(inp.offsetHeight > inp.offsetWidth),
                                        classNames:     getAttribute(inp, "data-fd-sliders-vertical"),
                                        html5Shim:      true
                                };

                                if(options.vertical && !getAttribute(inp, "data-fd-sliders-vertical")) {
        ...
        function fdRange(options) {
                ...
                // Set the "userSet" variable programmatically for this sliders
                ...
                function disableSlider(noCallback) {
                        ...
                        clearTimeout(timer);
                        removeClass(outerWrapper, "fd-sliders-focused");
                        removeClass(outerWrapper, "fd-sliders-active");

                        addClass(outerWrapper, "fd-sliders-disabled");
                ...
                function enableSlider(noCallback) {
                        ...
                        removeClass(outerWrapper, "fd-sliders-disabled");
                ...
                // FOCUS & BLUR events
                function onFocus(e) {
                        addClass(outerWrapper, 'fd-sliders-focused');
                ...
                // Mouseover the sliders
                function onMouseOver(e) {
                        addClass(outerWrapper, 'fd-sliders-hover');
                };

                // Mouseout of the sliders
                function onMouseOut(e) {
                        // Should really check we are not still in the sliders
                        removeClass(outerWrapper, 'fd-sliders-hover');
                };

                // Mousedown on the sliders
                function onMouseDown(e) {
                        ...
                        if(targ.className.search("fd-sliders-handle") != -1) {
                                ...
                                addClass(outerWrapper, 'fd-sliders-active');
                                addClass(document.body, "fd-sliders-drag-" + (vertical ? "vertical" : "horizontal"));
                ...
                function stopDrag(e) {
                        ...
                        kbEnabled   = true;
                        removeClass(document.body, "fd-sliders-drag-" + (vertical ? "vertical" : "horizontal"));
                        removeClass(outerWrapper, "fd-sliders-active");
                ...
                // Increments the sliders by "inc" steps
                ...
                // Attempts to locate the on-screen position of the sliders
                function locate(){
                        var curleft = 0,
                            curtop  = 0,
                            obj     = outerWrapper;
                ...
                // Calculates value according to pixel position of sliders handle
                ...
                // Rounds a pixel value to the nearest "snap" point on the sliders scale
                ...
                function setInputValue(val) {
                        ...
                        // to enable styling of the sliders
                        if(!userSet) {
                                addClass(outerWrapper, "fd-sliders-no-value");
                        } else {
                                removeClass(outerWrapper, "fd-sliders-no-value");
                        };
                ...
                (function() {
                        ...
                        outerWrapper.className    = "fd-sliders" + (vertical ? "-vertical " : " ") + (!html5Shim ? " fd-sliders-no-value " : "") + classNames;
                        outerWrapper.id           = "fd-sliders-" + inp.id;
                        ...
                        wrapper.className         = "fd-sliders-inner";

                        bar                       = document.createElement('span');
                        bar.className             = "fd-sliders-bar";

                        if(!noRangeBar) {
                                rangeBar                  = document.createElement('span');
                                rangeBar.className        = "fd-sliders-range";
                        };
                        ...
                        handle.className          = "fd-sliders-handle";
                        ...
                        if(lbl) {
                                ...
                                handle.id = "fd-sliders-handle-" + inp.id;
                                /*@cc_on
                                /*@if(@_win32)
