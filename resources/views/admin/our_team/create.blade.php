                ...
                <form id="form_id" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left needs-validation " novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-6 col-xs-12">
                            <input type="text" required="required" name="name_surname" class="form-control col-md-7 col-xs-12" placeholder="Məs(Vəliyev Elman Akif oğlu)" value="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-6 col-xs-12">
                            <input type="text" required="required" name="position" class="form-control col-md-7 col-xs-12" placeholder="Məs(Laboratoriya müdürü)" value="">
                            <div class="invalid-feedback">
                                Xana boş ola bilməz!
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-6 col-xs-12">
                            <input type="text" required="required" name="position_descr" class="form-control col-md-7 col-xs-12" placeholder="Məs(İxtisas - Ümumi aqronom)" value="">
                            <div class="invalid-feedback">
                                Xana boş ola bilməz!
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-6 col-xs-12">
                            <input type="text" required="required" name="email_adress" class="form-control col-md-7 col-xs-12" placeholder="Məs(vəliyev@splab.az)" value="">
                            <div class="invalid-feedback">
                                Xana boş ola bilməz!
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-2 col-sm-6 col-xs-12 col-md-offset-2">
                            ...
                            <button type="button" form="form_id" id="save_btn" class="btn btn-success">Tamamla</button>
                        </div>
                    </div>
                </form>
            </div>
