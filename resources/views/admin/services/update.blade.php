                                                ...
                                                <div class="form-group w-30">
                                                    ...
                                                    <div class="d-flex">
                                                        <select  class="form-select fs-15 border " name="sel_name" id="sel_cls">                                                                         placeholder="Seçiminizi edin...">
                                                            @foreach($services_catnames as $services_catname)
                                                                <option value="{{$services_catname->id}}"  {@if($services_catname->category_name==$servs->CollectServiceAndChild->category_name) selected="selected"  @endif} >{{$services_catname->category_name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <!-- Small modal -->
                                            ...
                                            <div >
                                                <div class="col-lg-7 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="form-group w-80 m-0" style="margin-bottom: 0px; margin-left: 10px">
                                                        <div>
                                                            <input type="text"  class="form-control"  name="name" value="{{$servs->name}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-5 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="form-group w-60 m-0" style="margin-bottom: 0px; margin-left: 10px">
                                                        <div>
                                                            <input type="text"  class="form-control"  name="day" value="{{$servs->day}}">
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#upd_btn',function (){
                ...
                $.ajax({
                    type:"POST",
                    url:"{{route('services.update',$servs->id)}}",
                    data:{
